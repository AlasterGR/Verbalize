    ...
    internal class FileHandling
    {
        ...
        public static void Load_Text()
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                Form1.label_FileName.Text = Path.GetFileName(locationLoadedFile); // Show the loaded file's name                
                //label1.Font = new Font(Label.DefaultFont, FontStyle.Bold);
                Form1.ActiveForm.Text = Form1.applicationBrandName + " : " + Form1.label_FileName.Text /*+ Path.GetFileNameWithoutExtension(locationLoadedFile) + Path.GetExtension(locationLoadedFile)*/;

                Form1.label_FileName_in_menustrip.Visible = true;
                Form1.label_FileName.Visible = true;

                Form1.label_FileName_in_menustrip.Text = Form1.label_FileName.Text;
                ...
                Form1.mainSingleTextBox.Text = fileContents;
                #endregion               
            }
